%% fig2_innate_analysis.m
% Innate immune flow cytometry analysis
...
% Order matches cellTypes: DCs, cd11b_pos, lymphoid_DCs, macrophages,
%                          monocytes, myeloid_DCs, neutrophils
...
title('PCA: Innate immune cell types');
...
title('tSNE: Innate immune cell types');
...
%% Bar plot — descriptive with individual points
% Note: n=3 per group; minimum detectable p = 0.1 with Wilcoxon
% Neutrophil and monocyte gates had low cell recovery — interpret with caution
figure;
hold on;
...
set(gca, 'FontName', 'Arial', 'FontSize', 20);
xlabel('Innate immune cell type');
