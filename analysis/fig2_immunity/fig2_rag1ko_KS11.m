%% fig2_rag1ko_KS11.m
% KS11 experiment — RAG1 KO protection analysis
% Uses cleaned rechallenge weight data from KS11_rechallenge_relweight.xlsx
% Run with MATLAB working directory set to data/raw/mouse/

%% Load clean data
tbl = readtable('KS11_rechallenge_relweight.xlsx');
...
for g = 1:3
    ...
    % Mean and SD from surviving mice
